        ...
        <p style={{ color: "white" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Remenber Run"
              description="A Small gave which you goes each level that tests your remembering skill."
              ghLink="https://github.com/Jikkesh/RememberRun"
              demoLink="https://jikkesh.github.io/RememberRun/"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/Jikkesh/RollDice"
              demoLink="https://jikkesh.github.io/RollDice/" 
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/Jikkesh/Drums"
              demoLink="https://jikkesh.github.io/Drums/"    
            />
          </Col>
